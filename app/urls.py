...
# login authentication
    path('customerregistraion/',views.CustomerRegistrationView.as_view(),name='customerregistraion'),
...
# forget password
    ...
    path('password-reset-conform/<uidb64>/<token>',auth_view.PasswordResetConfirmView.as_view(template_name='password_reset_confirm.html',form_class=MySetPasswordForm),name='password_reset_confirm'),
